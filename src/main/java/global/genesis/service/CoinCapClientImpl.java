...
public class CoinCapClientImpl implements CoinCapClient {
	...
	private static final Logger LOGGER = Logger.getLogger(CoinCapClientImpl.class.getName());
	...
	public CoinCapClientImpl(CryptoWalletHttpClient cryptoWalletHttpClient) {
